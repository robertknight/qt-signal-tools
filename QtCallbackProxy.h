...
class QtCallbackProxy : public QObject
{
	...
	public:
		 ...
		 * receives @p event.
		 */
		void bind(QObject* sender, QEvent::Type event, const QtCallbackBase& callback, EventFilterFunc filter = 0);
		 ...
		 */
		static void connectEvent(QObject* sender, QEvent::Type event, const QtCallbackBase& callback, EventFilterFunc filter = 0);
